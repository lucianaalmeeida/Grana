...
func bloqAjuda(num):
	ajudaBloq = num
	get_node("Ajudas/ajuda"+str(num)).set_texture(load("res://sprites/buttom1.png"))
	get_node("Ajudas/ajuda"+str(num)).set_texture_pressed(load("res://sprites/buttom1-press.png"))
	if ajudaBloq == 1: #DICA
		dica = true
...
func on_timeout_complete():
	...
	if game.nivelTerminou == false:
		...
		game.mudar_scene("res://scenes/premiacao.tscn")
...
func aparecerAjuda():
	...
	if ajuda == "dicas":
		...
		texto.set_text("Você deseja aumentar 10 segundos do seu total?")
	elif ajuda == "tesoura":
...
func prossAjuda():
	...
	if ajuda == "dicas": #DICAS
		...
		if buttom1.get_pos() == Vector2(63, 607) and item1 != iCorreto:
			buttom1.set_pos(Vector2(-634.5,385))
		elif buttom2.get_pos() == Vector2(63, 729) and item2 != iCorreto:
			buttom2.set_pos(Vector2(760,570))
		elif buttom3.get_pos() == Vector2(63, 852) and item3 != iCorreto:
			buttom3.set_pos(Vector2(-634.5,753))
		elif buttom4.get_pos() == Vector2(63, 976) and item4 != iCorreto:
