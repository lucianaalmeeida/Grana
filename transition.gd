...
onready var okT = get_node("mediacao/okT")
...
func _process(delta):
	...
	if game.poupanca < game.premios[num][1]:
		get_node("comprar").set_texture(load("res://sprites/comprar.png"))
		get_node("comprar").set_texture_pressed(load("res://sprites/comprar-press.png"))
	elif game.premios[num][2] == false:
		get_node("comprar").set_texture(load("res://sprites/buttom_amarelo_normal.png"))
		get_node("comprar").set_texture_pressed(load("res://sprites/buttom_amarelo_press.png"))
...
func premioAdquirido():
	...
	get_node("comprar").set_texture(load("res://sprites/adquirido.png"))
	get_node("comprar").set_texture_pressed(load("res://sprites/adquirido-press.png"))
